...
def _write_markdown(pack: BackendEvidencePack, path: Path) -> None:
    ...
    lines.extend(
        [
            ...
            f"- optional_solver_evidence_summary_available: `{solver_micro['optional_solver_evidence_summary_available']}`",
            f"- optional_solver_evidence_summary_path: `{solver_micro['optional_solver_evidence_summary_path']}`",
            f"- rc8_backend_readiness_review_available: `{solver_micro['rc8_backend_readiness_review_available']}`",
            f"- rc8_backend_readiness_review_path: `{solver_micro['rc8_backend_readiness_review_path']}`",
            f"- solver_evidence_validation_maturity_mapping_available: `{solver_micro['solver_evidence_validation_maturity_mapping_available']}`",
            f"- solver_evidence_validation_maturity_mapping_path: `{solver_micro['solver_evidence_validation_maturity_mapping_path']}`",
            f"- solver_evidence_closed_for: `{', '.join(solver_micro['solver_evidence_closed_for'])}`",
            f"- solver_evidence_deferred_for: `{', '.join(solver_micro['solver_evidence_deferred_for'])}`",
            f"- optional_solver_evidence_review_complete: `{solver_micro['optional_solver_evidence_review_complete']}`",
            ...
            f"- mpb_decision_packet_available: `{solver_micro['mpb_decision_packet_available']}`",
            f"- mpb_decision_packet_path: `{solver_micro['mpb_decision_packet_path']}`",
            ...
            f"- approval_records_path: `{solver_micro['approval_records_path']}`",
            f"- solver_python_env_var: `{solver_micro['solver_python_env_var']}`",
            f"- profile_env_var: `{solver_micro['profile_env_var']}`",
            ...
            f"- all_optional_solver_execution_authorized: `{solver_micro['all_optional_solver_execution_authorized']}`",
