...
require(version["package_version"] == "0.9.0rc8.dev0", "unexpected package version")
...
require(backend_report["package"]["package_version"] == "0.9.0rc8.dev0", "backend report package mismatch")
