...
require(version["package_version"] == "0.9.0rc8", "unexpected package version")
...
require(backend_report["package"]["package_version"] == "0.9.0rc8", "backend report package mismatch")
