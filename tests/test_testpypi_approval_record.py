...
APPROVAL_RECORD = ROOT / "docs" / "testpypi_upload_approval_v0.9.0rc4.md"
...
def test_testpypi_upload_approval_record_documents_artifacts_and_token_safety():
    text = APPROVAL_RECORD.read_text(encoding="utf-8")
    assert "optical_spec_agent-0.9.0rc4-py3-none-any.whl" in text
    assert "optical_spec_agent-0.9.0rc4.tar.gz" in text
