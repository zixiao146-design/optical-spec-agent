...
def test_pyproject_core_packaging_metadata_present():
    ...
    assert project["version"] == "0.9.0rc5"
...
def test_packaging_gate_docs_and_pypi_decision_are_present():
    ...
    assert "Current package version on `main`: `0.9.0rc5`" in packaging_gate
    ...
    assert "Current main release draft: `0.9.0rc5`" in pypi_decision
