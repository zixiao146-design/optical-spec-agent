...
def test_public_contract_manifest_tracks_post_rc7_state_without_publish_or_upload():
    ...
    assert '"version_scope": "0.9.0rc9.dev0"' in text
    assert '"current_public_prerelease": "v0.9.0rc8"' in text
    ...
    assert '"v0_9_0rc8_tag_created": true' in text
    assert '"v0_9_0rc9_tag_created": false' in text
