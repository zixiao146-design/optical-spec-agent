...
def test_api_examples_readme_and_manifest_exist():
    ...
    assert manifest["current_main_development_version"] == "0.9.0rc9.dev0"
...
def test_api_version_and_readiness_fixtures_track_publication_state():
    ...
    assert version["package_version"] == "0.9.0rc9.dev0"
    assert version["current_public_prerelease"] == "v0.9.0rc8"
    ...
    assert readiness["main_development_version"] == "0.9.0rc9.dev0"
