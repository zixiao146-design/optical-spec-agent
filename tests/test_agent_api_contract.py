...
def test_agent_api_health_and_version_are_local_first():
    ...
    assert version_payload["package_version"] == "0.9.0rc9.dev0"
    assert version_payload["current_public_prerelease"] == "v0.9.0rc8"
    assert version_payload["main_development_version"] == "0.9.0rc9.dev0"
...
def test_agent_api_validation_evidence_and_readiness_bound_claims():
    ...
    assert readiness_payload["current_public_prerelease"] == "v0.9.0rc8"
    assert readiness_payload["main_development_version"] == "0.9.0rc9.dev0"
