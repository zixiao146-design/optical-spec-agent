...
def test_testpypi_dry_run_gate_doc_exists_and_requires_manual_approval():
    ...
    assert "docs/testpypi_upload_approval_v0.9.0rc7.md" in text
    assert "docs/testpypi_upload_attempt_v0.9.0rc6.dev0.md" in text
    assert "docs/testpypi_status_v0.9.0rc6.dev0.md" in text
    assert "TestPyPI upload approval status for 0.9.0rc9.dev0: pending" in text
    assert "Upload command authorized for 0.9.0rc9.dev0: no" in text
