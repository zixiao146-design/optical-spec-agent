...
def test_testpypi_dry_run_gate_doc_exists_and_requires_manual_approval():
    ...
    assert "TestPyPI upload for 0.9.0rc6: not performed" in text
    ...
    assert "TestPyPI upload approval status for rc6: pending" in text
    assert "TestPyPI upload authorized for rc6: no" in text
