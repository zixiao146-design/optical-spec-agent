...
def test_backend_evidence_summary_api_returns_safe_review_sections():
    ...
    assert body["package_and_release_status"]["current_public_prerelease"] == "v0.9.0rc8"
    assert body["package_and_release_status"]["main_development_version"] == "0.9.0rc9.dev0"
