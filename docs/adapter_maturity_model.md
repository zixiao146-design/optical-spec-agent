...
|---|---|---|---|---|---|---|---|
| Meep | Level 3 - Optional manual solver validation | Registered and CLI-visible; generates local Meep Python preview artifacts with diagnostics and fixture coverage. A narrow opt-in pilot generated the adapter preview artifact and executed a tiny project-owned PyMeep validation path; the separately approved 2026-05-20 Meep-only micro-benchmark passed through `OSA_SOLVER_PYTHON` and was reviewed as PyMeep/FDTD smoke evidence. Default tests, smoke, quality gates, CI, and release validation still do not run Meep. | `tests/test_meep_adapter.py`, `tests/test_adapter_evidence_fixtures.py`, `tests/fixtures/adapter_golden/meep_missing_wavelength_expected_fragments.txt`, `docs/meep_optional_validation_pilot.md`, `docs/meep_level3_readiness.md`, `validation/meep/meep_validation_pilot_2026-05-14.md`, `validation/meep/meep_micro_benchmark_2026-05-20.md`, `docs/optional_solver_approval_records/meep_micro_benchmark_review_2026-05-20.md` | no | yes, only for explicit opt-in pilots and the approved/reviewed 2026-05-20 Meep-only micro-benchmark | no | Define a reproducible solver-backed benchmark before considering Level 4. |
