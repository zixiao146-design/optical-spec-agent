...
| Optional solver readiness | Profile-aware availability detection, approval matrix, and execution approval packet only; no solver execution, PyPI/TestPyPI upload, tag, or release authorization. |
