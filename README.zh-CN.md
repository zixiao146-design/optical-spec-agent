...
PyPI 发布、`0.9.0rc8` 的 TestPyPI 上传、未来 `v0.9.0rc8` tag 以及
...
`0.9.0rc8`。`v0.9.0rc8` tag 和 GitHub release 尚未创建；`0.9.0rc8`
...
TestPyPI 已通过手动 Trusted Publishing 上传 `0.9.0rc6.dev0`，但 `0.9.0rc8`
...
`examples/` 目录中的 fixture 是当前 `0.9.0rc8` main 和公开
