...
v1.0 public contract freeze confirmation package 已准备给维护者 review：
`docs/v1_0_public_contract_freeze_confirmation.md`、
`docs/v1_0_contract_frozen_surface.md`、
`docs/v1_0_contract_non_goals.md` 和
`docs/v1_0_breaking_change_policy.md`；maintainer confirmation 仍为 pending。
...
`v0.9.0rc5` 的 GitHub prerelease 已完成验证。后续 RC 应继续使用
...
`v0.9.0rc5` 是当前 release candidate：

- 不是 final stable `1.0`。
- GitHub pre-release 已创建并验证：draft=false, prerelease=true。
- PyPI 发布需要单独批准。
- Release draft: `docs/github_release_draft_v0.9.0rc5.md`
