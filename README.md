...
8 golden-case regression tests ensure parser output stays stable across changes.
...
**What it tests:** exact key-field matching — the live parser output is compared field-by-field against stored golden JSON snapshots. Covers nanoparticle_on_film, waveguide, metasurface, and fitting tasks in both Chinese and English.
