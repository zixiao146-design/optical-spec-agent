...
- EN: Preview Gaussian beam focusing with waist, Rayleigh range, and focal spot estimates.
- ZH: 请预览高斯光束聚焦，包含光腰、瑞利长度和焦斑估计。

## Expected Behavior

- Scenario type: `positive`
- Expected primary domain: `gaussian_beam_focusing`
